...
class Interface:
    ...
    def createBackground(self):
        ...
        self.background.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "background.png"))
    ...
    def createButtons(self):
        ...
        self.instrumentsImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "instruments.png"))
        ...
        self.composeImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "compose1.png"))
        ...
        self.clearImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "clear1.png"))
        ...
        self.selectImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "select1.png"))
        ...
        self.copyImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "copy.png"))
        self.copyImage.show()
        ...
        self.cutImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "cut.png"))
        self.cutImage.show()
        ...
        self.pasteImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "paste.png"))
        ...
        self.stopImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "stop.png"))
        self.stopImage.show()
        ...
        self.playImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "play.png"))
        self.playImage.show()
        ...
        self.notesImage.set_from_file(os.path.join(activity.get_bundle_path(), "gui/pixmaps/" + "notes.png"))
