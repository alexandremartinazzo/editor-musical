...
class Buttons:
    ...
    def deselectAllButtons(self):
        self.grid.gui.composeImage.set_from_file(os.path.join(activity.get_bundle_path(), "pixmaps/" +"compose1.png"))
        self.grid.gui.clearImage.set_from_file(os.path.join(activity.get_bundle_path(), "pixmaps/" +"clear1.png"))
        self.grid.gui.selectImage.set_from_file(os.path.join(activity.get_bundle_path(), "pixmaps/" +"select1.png"))

    def callbackComposePress(self, widget, context):
        # Highlight the box
        self.deselectAllButtons()
        self.grid.gui.composeImage.set_from_file(os.path.join(activity.get_bundle_path(), "pixmaps/" +"compose2.png"))
    ...
    def callbackClearPress(self, widget, context):
        # Highlight the box
        self.deselectAllButtons()
        self.grid.gui.clearImage.set_from_file(os.path.join(activity.get_bundle_path(), "pixmaps/" +"clear2.png"))
    ...
    def callbackSelectPress(self, widget, context):
        # Highlight the box
        self.deselectAllButtons()
        self.grid.gui.selectImage.set_from_file(os.path.join(activity.get_bundle_path(), "pixmaps/" +"select2.png"))
