...
class Interface:
    ...
    def createButtons(self):
        ...
        self.columnsImage.set_from_file(os.path.join(activity.get_bundle_path(), "pixmaps/" + "column.png"))
...
class InstrumentSelection:
    ...
    def __init__(self, parentWindow):
        ...
        for name in images:
            image = gtk.Image()
            image.set_from_file(os.path.join(activity.get_bundle_path(), "pixmaps/instruments/" + name + '.png'))
            button = gtk.Button()
            button.add(image)
